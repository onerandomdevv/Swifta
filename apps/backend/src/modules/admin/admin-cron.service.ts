...
/**
 * Admin cron service for system health monitoring.
 *
 * NOTE: Auto-confirm delivery logic has been intentionally removed from this service.
 * It is handled EXCLUSIVELY by AutoConfirmProcessor (BullMQ) in src/queue/auto-confirm.processor.ts.
 * Do NOT re-add auto-confirm logic here — it will cause double payouts.
 */
@Injectable()
