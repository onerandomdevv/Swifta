  ...
  if (isSubmitted) {
    return (
      <div className="w-full max-w-md animate-in fade-in zoom-in duration-500">
        <div className="bg-surface shadow-xl border border-border rounded-xl p-8 md:p-10 text-center">
          ...
          <h1 className="text-2xl font-black text-foreground tracking-tight uppercase mb-4">
            Check Your Email
          </h1>
          <p className="text-foreground-secondary text-sm font-bold leading-relaxed mb-8">
          ...
          <Link
            href="/login"
            className="w-full inline-flex justify-center items-center h-12 rounded-xl bg-background-secondary text-foreground font-black text-xs uppercase tracking-[0.2em] hover:bg-surface transition-colors"
          >
    ...
    <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-surface shadow-xl border border-border rounded-xl p-8 md:p-10">
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-foreground-secondary mt-2 text-xs font-bold uppercase tracking-widest">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                className="pl-12 bg-background-secondary border-2 border-border h-14 rounded-2xl text-sm font-bold focus:border-primary transition-all shadow-none"
                id="email"
                type="email"
