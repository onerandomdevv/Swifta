...
const whatsappLink = WHATSAPP_NUMBER
  ? `https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20SwiftTrade!%20I%20want%20to%20start%20trading`
  : "#";
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    stars: 5,
    text: "As a merchant, SwiftTrade changed my business. I manage everything from WhatsApp — products, orders, payouts. My revenue has tripled in 3 months.",
  },
  {
    name: "Emeka Obi",
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              <Logo variant="dark" size="md" />
              <p className="mt-4 text-white/50 text-sm font-medium leading-relaxed max-w-xs">
                Your one-stop WhatsApp marketplace. Buy and sell anything with
                escrow payment protection and verified merchants.
              </p>
            </div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-[#25D366] hover:text-[#1ebe5c] text-sm font-bold flex items-center gap-2 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-white/30 text-sm font-medium">
              &copy; {new Date().getFullYear()} SwiftTrade Technologies. All
              rights reserved.
            </p>
