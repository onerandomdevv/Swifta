        ...
        <div className="space-y-10 py-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center gap-6">
                ...
                <div className="space-y-1">
                    <h1 className="text-4xl font-black text-navy-dark dark:text-white tracking-tight uppercase leading-none font-display">Log New Inventory</h1>
                    <p className="text-slate-500 font-bold text-sm tracking-wide mt-2">Add hardware materials to your digital warehouse</p>
                </div>
            </div>
            ...
            <div className="max-w-4xl">
                <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2.5rem] p-10 shadow-xl shadow-navy-dark/5 space-y-10">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Technical Notes (Optional)</label>
                            <textarea
                                ...
                                placeholder="Batch numbers, manufacturer details, or storage conditions..."
                            />
                        </div>
                    </div>
                    ...
                    <div className="pt-8 border-t border-slate-50 dark:border-slate-800 flex justify-end">
                        ...
                        >
                            {isSubmitting ? 'Logging...' : 'Add to Inventory'}
