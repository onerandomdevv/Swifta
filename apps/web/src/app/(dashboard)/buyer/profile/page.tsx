  ...
  return (
    <div className="flex-1 flex flex-col font-display bg-[#f9fafb] min-h-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            <div className="flex border border-slate-200">
              <button className="px-6 py-2 text-xs font-bold border-b-2 border-primary text-slate-900 uppercase">
                General
              </button>
              <button className="px-6 py-2 text-xs font-bold border-b-2 border-transparent text-slate-400 hover:text-slate-900 uppercase transition-colors">
                Documents
              </button>
              <button className="px-6 py-2 text-xs font-bold border-b-2 border-transparent text-slate-400 hover:text-slate-900 uppercase transition-colors">
                Billing
            ...
            <button className="bg-primary text-white text-xs font-bold px-8 py-3 uppercase tracking-widest hover:bg-orange-800 transition-colors w-full md:w-auto">
              Save Changes
            </button>
          </div>
        </div>
      ...
      <main className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 px-4 text-sm rounded-none border-slate-300 focus:border-primary focus:ring-1 focus:ring-primary placeholder:text-slate-300"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full h-12 px-4 text-sm bg-white rounded-none border-slate-300 focus:border-primary focus:ring-1 focus:ring-primary">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  value={user?.email || ""}
                  readOnly
                  className="w-full h-12 px-4 text-sm bg-slate-50 text-slate-400 border-slate-200 cursor-not-allowed rounded-none focus:ring-0 focus:border-slate-200"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-4 text-sm rounded-none border-slate-300 focus:border-primary focus:ring-1 focus:ring-primary placeholder:text-slate-300 resize-none"
                />
              </div>
            </div>
          </section>
        ...
        {/* Security Settings Section (Moving outside the main grid for full-width) */}
        <section className="bg-white border border-slate-200 p-8 shadow-sm">
          <div className="flex items-center gap-3 mb-8 border-b border-slate-100 pb-4">
