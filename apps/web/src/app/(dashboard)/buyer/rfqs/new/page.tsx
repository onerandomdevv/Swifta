...
export default function CreateRFQPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Strict Compliance Check: Creating RFQ with budget in Kobo:', budgetInKobo.toString());
    ...
    <div className="space-y-10 py-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center gap-6">
        ...
        <div className="space-y-1">
          <h1 className="text-4xl font-black text-navy-dark dark:text-white tracking-tight uppercase leading-none font-display">New Material RFQ</h1>
          <p className="text-slate-500 font-bold text-sm tracking-wide mt-2">Broadcast your requirements to verified Lagos merchants</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl">
        <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2.5rem] p-10 shadow-xl shadow-navy-dark/5 space-y-10">
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Material Specifications</label>
              <textarea
                required
        ...
        <div className="mt-10 p-8 bg-blue-50/50 dark:bg-blue-900/10 rounded-[2.5rem] border border-dashed border-blue-200 dark:border-blue-900/30 flex items-start gap-6">
          <span className="material-symbols-outlined text-blue-500 font-black">gavel</span>
          <p className="text-[11px] font-bold text-slate-600 dark:text-slate-400 leading-relaxed uppercase tracking-tight">
            Your RFQ will be sent to our pool of <span className="text-navy-dark dark:text-white font-black">200+ verified hardware merchants</span> across Lagos. You will receive quotes directly in your dashboard for comparison.
          </p>
        </div>
      </div>
    </div>
